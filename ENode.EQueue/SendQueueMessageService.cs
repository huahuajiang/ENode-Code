...
namespace ENode.EQueue
{
    internal class SendQueueMessageService
    {
        ...
        public async Task SendMessageAsync(Producer producer,string messageType,string messageClass,QueueMessage message,string messageBodyString,string routingKey, string messageId,IDictionary<string,string> messageExtensionItems)
        {
            try
            {
